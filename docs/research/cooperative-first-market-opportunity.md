# Cooperative-first market opportunity
...
The evidence supports testing this wedge, but not describing it as an empty category.

- Mobile gaming is already normal and social for teenagers. In a representative US survey, 85% of 13–17-year-olds played video games, 70% played on smartphones, 89% of teen Players played with others in person or online, and 72% said spending time with others was a reason they played.[^pew-games] A separate US study focused on social context found that, in a typical week, 70% of surveyed 13–17-year-olds did some same-room two-Player gaming and 62% did some same-room group gaming.[^digital-wellness]
- The same audience feels tension around individual phone use. In 2024 survey data, 45% of US teens said they spent too much time on social media and 44% said they had cut back on smartphone use.[^pew-social] UK data published in 2026 similarly found that 37% of 8–17-year-olds thought their screen time was too high, rising to 44% at age 16–17.[^ofcom]
- Co-located gaming is not automatically cooperative or social. In the same US social-context study, only 46% of local multiplayer was rated collaborative and 53% social, even though 78% was rated positive.[^digital-wellness] The opportunity is to improve the quality of an existing behavior, not invent co-present teen gaming.
- Several current products already prove parts of the proposition: Wavelength is a cross-platform, fully cooperative, synchronous phone game for in-person or remote groups; Spaceteam gives every Player a phone and makes coordination the game; and DUAL links two phones for competitive and cooperative action.[^wavelength][^spaceteam][^dual]
- The less-served intersection in the reviewed set is not “cooperative game on phones.” It is a **catalog designed first for three or four friends already together, with a shared cooperative state on their separate phones, no TV, no public lobby or stranger chat, and a 5–20 minute commitment**. This is an inference from a bounded competitor review, not proof that no other product occupies it.
...
## What the audience evidence does—and does not—say

### Evidence

1. **The required hardware is broadly present.** Pew found smartphone access among 95% of US teens aged 13–17 in 2024; access was 90% for ages 13–14 and 98% for ages 15–17.[^pew-tech] Ofcom reports that 94% of UK secondary-school-age children own a mobile phone and that 96% of phone-owning children have a smartphone.[^ofcom]

2. **Gaming is not limited to self-identified “gamers.”** Pew found that 85% of US teens played games, but only 40% identified as gamers. Smartphone play was similarly common among self-identified gamers and other teens who played games, unlike console and PC play.[^pew-games] That makes a casual, phone-native proposition plausible beyond dedicated competitive gamers.
...
Evidence supports three claims:

1. Social multiplayer, mobile play, cooperative coordination, party-game catalogs, and co-located phone controllers are each established behaviors or product categories.
2. Current leaders simplify group economics and joining: one Host purchase, an existing subscription, a browser code, or one Player's unlock can cover the group.[^dual][^jackbox][^netflix]
3. The reviewed direct competitors are primarily single games, two-Player action, or speech-heavy coordination; the reviewed catalogs center online chat, competition, or a shared TV.

The resulting unmet need is an **inference**: a small, private, no-TV catalog might occupy a useful middle ground between a one-off party game and a remote social network. The prototypes must establish whether that intersection produces better co-located behavior, not merely whether Players understand the pitch.

## Riskiest assumptions

Ordered by how quickly they could invalidate a particular launch direction—not Cooperative-First itself:

1. **Cooperation redirects attention to the group.** Separate synchronized screens may still produce parallel solo play. This is the central mechanic risk.
...
**Failure pattern that triggers a partial pivot:** Players silently exhaust interface options, one confident Player becomes the sole coordinator, or the mechanic feels like a rules lesson. If interaction occurs only after moderator prompting, asymmetric inference should not lead the first Game Session.

### Prototype B: Common Pulse — real-time complementary control

**Frame:** The group keeps one lively shared entity or vehicle stable through short waves. Each phone controls a different dimension—direction, energy, shielding, timing, or rescue—and displays immediate consequences from teammates' actions. Players can succeed through timing and observation; speech is optional.

**Why this contrast:** DUAL demonstrates the appeal of action crossing screens, while Spaceteam demonstrates frantic interdependence.[^dual][^spaceteam] Common Pulse tests a three-to-four-Player, non-adversarial version in which emotion and help can emerge from timing rather than semantic clue exchange.

**Hypothesis:** Complementary real-time controls will produce unprompted coaching, rescues, laughter, groans, and shared attention while remaining more accessible across language, confidence, and Family Play differences than Split Signal.
...
| Signal | Operational observation |
| --- | --- |
| **Inspired Social Interaction** | Time to first unprompted hint, help, rescue, reaction, glance, gesture, or emotional exchange directed at another Player. Code the categories, not just total speech. |
| **Participation balance** | Whether every Player contributes to a successful action and receives or offers help; note coordinator dominance and socially stranded Players. |
| **Screen displacement** | Any 30-second stretch after onboarding with no peer-directed behavior, plus whether Players can explain a teammate's contribution at the end. |
| **Onboarding** | Time from Host start to the first correct coordinated action; moderator interventions; points of confusion. |
| **Completion** | Whether the group finishes a round and understands why it won or lost. |
...
## Evidence-driven partial pivots
...
| Replay is weak despite lively first rounds | Treat the mechanic as a novelty, not an MVP anchor; vary roles, escalating shared goals, and rematch state before adding catalog breadth. |

## What remains unknown after desk research

- Observed (rather than self-reported) co-located behavior of 13–19-year-old friend groups using separate synchronized phones.
- App-install and Session Invitation completion in a spontaneous hangout.
- Whether the launch occasion is more often a three-to-four-Player friend group, a two-Player pair, waiting time, or at-home Family Play.
- Which cooperative mechanic creates repeatable Social Interaction rather than a one-session novelty.
- Willingness to pay, acceptable Group Unlock price, and whether the paying Player is usually the Host or another group member.
- Acquisition language and channels that reach teen groups without relying on public social features.

Those unknowns are the purpose of the prototypes and subsequent observed sessions; they should not be filled with additional desk-research confidence.

## Sources

All sources below are first-party product pages, official store listings, or primary research reports. Store metrics are point-in-time snapshots and should not be read as active users or demographic evidence.

[^pew-games]: Pew Research Center, [“Teens and Video Games Today”](https://www.pewresearch.org/internet/2024/05/09/teens-and-video-games-today/), 9 May 2024. Representative US survey fielded September–October 2023.
[^pew-tech]: Pew Research Center, [“Teens, Social Media and Technology 2024”](https://www.pewresearch.org/internet/2024/12/12/teens-social-media-and-technology-2024/), 12 December 2024.
[^pew-screens]: Pew Research Center, [“How Teens and Parents Approach Screen Time”](https://www.pewresearch.org/internet/2024/03/11/how-teens-and-parents-approach-screen-time/), 11 March 2024.
[^pew-social]: Pew Research Center, [“Social Media and Teens' Mental Health: What Teens and Their Parents Say”](https://www.pewresearch.org/internet/2025/04/22/teens-social-media-and-mental-health/), 22 April 2025. Survey fielded September–October 2024.
[^digital-wellness]: Boston Children's Hospital Digital Wellness Lab, [“Adolescent Media Use: Digital Gaming and Social Interaction”](https://digitalwellnesslab.org/wp-content/uploads/Digital-Wellness-Lab-Pulse-Report-Apr-2024.pdf), April 2024. US online survey of 1,468 adolescents aged 13–17, fielded 3–10 November 2023; self-reported behavior across devices and genres.
[^ofcom]: Ofcom, [“Children and Parents: Media Use and Attitudes Report 2025–26”](https://www.ofcom.org.uk/siteassets/resources/documents/research-and-data/media-literacy-research/children/2026-children-and-parents-report/children-and-parents-media-use-and-attitudes-report-2025-6.pdf?v=418231), published 21 May 2026 on Ofcom's [Children's Media Use and Attitudes](https://www.ofcom.org.uk/media-use-and-attitudes/media-habits-children/childrens) page.
[^common-sense]: Common Sense Media and University of Michigan researchers, [“Constant Companion: A Week in the Life of a Young Person's Smartphone Use”](https://www.commonsensemedia.org/sites/default/files/research/report/2023-cs-smartphone-research-report_final-for-web.pdf), 2023. The Android-only convenience sample limits generalization.
[^esa]: Entertainment Software Association, [“2026 Essential Facts About the U.S. Video Game Industry”](https://www.theesa.com/resources/essential-facts-about-the-us-video-game-industry/2026-data/), 3 June 2026. Industry-sponsored survey; family findings do not isolate parent–teen, co-located, or mobile play.
[^wavelength]: CMYK Games/Palm Court, [Wavelength on Google Play](https://play.google.com/store/apps/details?id=com.PalmCourt.Wavelength&hl=en_US) and [Wavelength on the US App Store](https://apps.apple.com/us/app/wavelength/id1512834505), accessed 10 July 2026.
[^spaceteam]: Henry Smith Inc., [Spaceteam on the US App Store](https://apps.apple.com/us/app/spaceteam/id570510529), accessed 10 July 2026.
[^dual]: Seabaa, [DUAL! on Google Play](https://play.google.com/store/apps/details?id=com.Seabaa.Dual&hl=en_US), accessed 10 July 2026.
[^plato]: Plato Team Inc., [Plato: Fun Multiplayer Games on Google Play](https://play.google.com/store/apps/details?id=com.plato.android&hl=en_US), accessed 10 July 2026.
[^among-us]: Innersloth, [“Among Us” official game page](https://www.innersloth.com/games/among-us/), accessed 10 July 2026.
[^jackbox]: Jackbox Games, [“How to Play Jackbox Games”](https://www.jackboxgames.com/how-to-play), accessed 10 July 2026.
[^airconsole]: AirConsole, [official product page](https://www.airconsole.com/) and [company overview](https://corp.airconsole.com/), accessed 10 July 2026.
[^netflix]: Netflix Tudum, [“Play Netflix Party Games on Your TV”](https://www.netflix.com/tudum/articles/netflix-party-games-play-on-tv), 9 April 2026.
