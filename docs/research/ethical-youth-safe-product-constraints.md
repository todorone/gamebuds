...
| --- | --- | --- |
| Brazil | Google says the Digital Child and Adolescent Statute took effect on 17 March 2026 and requires apps aimed at or likely accessed by children/adolescents to ingest store age ranges; it also prohibits loot boxes in those games. Play Age Signals 0.0.3 is the current beta integration. Apple likewise exposes Brazil age categories through Declared Age Range when the user or guardian agrees to share them.[^google-country-requirements][^apple-age-regions] | Keep loot boxes excluded; implement and test both stores' Brazil signals and ClassInd/IARC declarations before allowlisting Brazil. |
| Australia | The OAIC says its Children's Online Privacy Code will be finalised and registered by 10 December 2026 and will cover apps and games likely to be accessed by children. Apple already blocks unconfirmed minors from downloading 18+ apps in Australia.[^oaic-code][^apple-age-regions] | Recheck the final Code at launch, update the DPIA/data flows, and release only with a classification that admits 13-year-olds. |
